...
namespace Microsoft.Data.Entity.Metadata.Builders
{
        ...
        where TEntity : class
    {
        ...
        /// <summary>
        ///     Creates a new unique index for this entity type if one does not already exist over the specified properties.
        /// </summary>
        /// <param name="keyExpression">
        ///     <para>
        ///         A lambda expression representing the unique index property(s) (<c>t => t.Id1</c>).
        ///     </para>
        ///     <para>
        ///         If the unique index is made up of multiple properties then specify an anonymous type including the
        ///         properties (<c>t => new { t.Id1, t.Id2 }</c>).
        ///     </para>
        /// </param>
        /// <returns> An object that can be used to configure the unique index. </returns>
